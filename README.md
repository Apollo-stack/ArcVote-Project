...
**ArcVote** is a dApp (Decentralized Application) built on the **Arc Network Testnet**.
It allows users to cast votes for their favorite assets in a transparent, immutable, and spam-resistant way.
